                                  ...
                                  {vaccinatedPeople &&
                                    ...
                                    vaccinatedPeople.map((vaccinate) => (
                                      <tr key={vaccinate.firstName}>
                                        ...
                                        <td>{vaccinate.emergPhoneNumber}</td>
                                        <td>{vaccinate.address}</td>
                                        <td>{vaccinate.bloodGroup}</td>
                                        <td>{vaccinate.allergies}</td>
                                        <td>{vaccinate.symptoms}</td>
                                        <td>{vaccinate.diagnosis}</td>
                                        <td>
                                          <a
