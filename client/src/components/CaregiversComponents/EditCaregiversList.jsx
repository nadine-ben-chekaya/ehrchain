...
const EditCaregiversList = () => {
  return (
    <div>
      <Form>
        <Form.Row>
          <Form.Group as={Col} controlId="patientName">
            <Form.Label>Nasssme</Form.Label>
            <Form.Control
              type="name"
              placeholder="Name"
              value="Titus Miskelly"
            />
          </Form.Group>
          ...
          <Form.Group as={Col} controlId="email">
            ...
            <Form.Control
              type="email"
              placeholder="Email"
              value="mmcjarrow0@kickstarter.com"
            />
          </Form.Group>
        </Form.Row>
...
export default EditCaregiversList;
