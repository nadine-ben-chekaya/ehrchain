...
chaincodeInvoke(){
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:15051 --tlsRootCertFiles $PEER0_INSURANCE_CA $PEER_CONN_PARMS  \
         -c '{"function": "AddPatient","Args":["patientl","foulen8","benfoulen2","18","mounastir, jemmel"]}'
       # -c '{"function": "AddPatient,"Args":["{\"id\":\"patientl\",\"firstName\":\"foulen8\",\"lastName\":\"benfoulen2\",\"age\":18, \"address\":\"\"}"]}'
       # -c '{"function": "TransferPatient","Args":["patientk", "sousse, sahloul"]}'
        #-c '{"function": "initLedger","Args":[]}'
        #-c '{"function": "TransferPatient","Args":["patientk", "sousse, sahloul"]}'
}
